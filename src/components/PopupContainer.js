...
const PopupContainer = ({ children, isOpen, onClose, Icon, title, closeFunction, closeIconVisible }) => {
    ...
    return (
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as="div" open={isOpen} onClose={onClose} className=" fixed z-50 inset-0 overflow-y-auto flex flex-row items-center justify-center backdrop-blur-sm">
                <Transition.Child
                    as={Fragment}
                ...
                <div className=" w-80 sm:w-[450px] fixed inset-0 flex items-center justify-center mx-auto">
                    <Transition.Child
                        ...
                        leaveTo="opacity-0"
                    >
                        <Dialog.Panel as="div" className="w-full relative z-50 bg-black3 bg-opacity-50 backdrop-blur-sm border border-gray1 border-opacity-60 rounded-xl pt-5 px-7 pb-5 text-gray2">
